...
var useTypeFilter = function useTypeFilter() {
  var _useReducer = Object(react__WEBPACK_IMPORTED_MODULE_8__["useReducer"])(reducer, initState),
      state = _useReducer[0],
      dispatch = _useReducer[1];

  var films = Object(_generated_graphql__WEBPACK_IMPORTED_MODULE_9__["useAllFilmsQuery"])();
  var persons = Object(_generated_graphql__WEBPACK_IMPORTED_MODULE_9__["useAllPersonsQuery"])();
  var starships = Object(_generated_graphql__WEBPACK_IMPORTED_MODULE_9__["useAllStarshipsQuery"])();
    ...
    if (state.browseType === "films") {
      ...
      try {
        var _loop = function _loop() {
          ...
          try {
            for (var _iterator2 = _babel_runtime_corejs2_core_js_get_iterator__WEBPACK_IMPORTED_MODULE_6___default()(f.characters), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
              var c = _step2.value;

              if (c.name === state.filterByCharacter) {
                console.log(true);
                var newList = state.mainList.filter(function (x) {
                  return x.id !== f.id;
                });
                dispatch({
                  type: 'setBrowse',
        ...
        for (var _iterator = _babel_runtime_corejs2_core_js_get_iterator__WEBPACK_IMPORTED_MODULE_6___default()(state.mainList), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          _loop();
        }
      } catch (err) {
...
//# sourceMappingURL=index.js.fab7fe6880bc2a24b52d.hot-update.js.map