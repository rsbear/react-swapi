    ...
    if (state.browseType === "films") {
      ...
      try {
        for (var _iterator = _babel_runtime_corejs2_core_js_get_iterator__WEBPACK_IMPORTED_MODULE_6___default()(state.mainList), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          if (f.characters.includes(state.filterByCharacter)) {
            console.log("film includes filterByCharacter");
          }
        }
      } catch (err) {
...
//# sourceMappingURL=index.js.60d063fc122b8a7b95d0.hot-update.js.map